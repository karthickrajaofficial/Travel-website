      ...
      <div className="relative h-[60vh] lg:h-[70vh]">
        <div className="absolute inset-0">
          <img                 
            ...
            src={subPackageDetails?.image ? `/package/${subPackageDetails.image}` : '/fallback-image.jpg'} 
            alt={subPackageDetails?.name || 'Package Image'} 
            className="w-full h-full object-cover"
          />
          <div className="absolute inset-0 bg-gradient-to-b from-blue-950/60 via-blue-950/40 to-blue-950"></div>
        </div>
        ...
        <div className="absolute inset-0 flex items-center">
          ...
          >
            ...
            <h1 className="text-4xl lg:text-6xl font-light text-white tracking-wider mb-4 max-w-4xl">
              {subPackageDetails?.name || 'Package Name Not Available'}
            </h1>
            <p className="text-xl text-gray-300 font-light max-w-2xl">
              {subPackageDetails?.title || 'No description available'}
            </p>
          </motion.div>
        </div>
      </div>
          ...
          >
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
              ...
              <div className="space-y-8">
                <div className="bg-slate-800/50 p-8 border border-yellow-400/20">
                  <p className="text-gray-300 font-light leading-relaxed">
                    {subPackageDetails?.description || 'No description available'}
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <ul className="grid gap-4">
                    {subPackageDetails?.highlights && Array.isArray(subPackageDetails?.highlights) && subPackageDetails?.highlights.length > 0 ? (
                      subPackageDetails.highlights.map((highlight, index) => (
                        <motion.li 
                          key={index}
                          initial={{ opacity: 0, x: -20 }}
                      ...
                      <p className="text-gray-300">No highlights available.</p>
                    )}
                  </ul>
                </div>
              </div>
